...
const DEFAULT_PREFIX = `You are Glaude Vibe Coder, a coding assistant app for software engineering tasks.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Glaude Vibe Coder, a coding assistant app for software engineering tasks, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Glaude Vibe Coder agent, built on Anthropic's Claude Agent SDK.`
